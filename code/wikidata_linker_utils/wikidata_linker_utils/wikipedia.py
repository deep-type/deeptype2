...
from .successor_mask import load_redirections, match_wikipedia_to_wikidata # noqa
...
def iterate_articles(path, skip_templated_lines=False):
    ...
    with almost_smart_open(path, "rb") as wiki:
        for article_name, lines in convert_wiki_to_lines(
                ...
                skip_templated_lines=skip_templated_lines,
